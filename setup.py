...
setup(
  ...
  url='https://github.com/vedavaapi/vedavaapi_py_api',
  ...
  keywords='sanskrit samskrtam samskritam',
  ...
  install_requires=[
    ...
    'jsonpickle', 'jinja2', 'Pillow', 'werkzeug', 'jsonschema', 'docimage', 'requests'
  ],
